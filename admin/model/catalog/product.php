...
class ModelCatalogProduct extends Model {
 ...
 // insert vào product_blog_related
		if (isset($data['blog_related'])) {
			foreach ($data['blog_related'] as $blog_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_blog_related WHERE product_id = '" . (int)$product_id . "' AND blog_id = '" . (int)$blog_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_blog_related SET product_id = '" . (int)$product_id . "', blog_id = '" . (int)$blog_id . "'");
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_blog_related WHERE product_id = '" . (int)$blog_id . "' AND blog_id = '" . (int)$product_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_blog_related SET product_id = '" . (int)$blog_id . "', blog_id = '" . (int)$product_id . "'");
			}
		}
	...
	public function editProduct($product_id, $data) {
		...
		// Blog -> product
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_blog_related WHERE product_id = '" . (int)$product_id."'");
		if (isset($data['blog_related'])) {
			foreach ($data['blog_related'] as $related_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_blog_related WHERE product_id = '" . (int)$product_id . "' AND blog_id = '" . (int)$related_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_blog_related SET product_id = '" . (int)$product_id . "', blog_id = '" . (int)$related_id . "'");
				// $this->db->query("DELETE FROM " . DB_PREFIX . "oc_product_blog_related WHERE product_id = '" . (int)$related_id . "' AND related_id = '" . (int)$product_id . "'");
				// $this->db->query("INSERT INTO " . DB_PREFIX . "oc_product_blog_related SET product_id = '" . (int)$related_id . "', related_id = '" . (int)$product_id . "'");
			}
		}
	...
	public function getProductblog($product_id) {
		$blog_related_data = array();

		$query = $this->db->query("SELECT blog_id FROM " . DB_PREFIX . "product_blog_related WHERE product_id = '" . (int)$product_id . "'");

		foreach ($query->rows as $result) {
			$blog_related_data[] = $result['blog_id'];
		}
