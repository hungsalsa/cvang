...
class ControllerModulepavproducts extends Controller {
	protected function index($setting) {
		...
		foreach( $setting['category_tabs'] as  $key => $categoryID ){
			...
			// Lấy ra các sub category của $categoryID trên
			$sub_categories = $this->model_catalog_category->getCategories($categoryID);
			...
			if( $category ) {
				...
				if(isset($sub_categories)){
					$this->data['tabs'][] = array('sub_categories' => $sub_categories);
				}
